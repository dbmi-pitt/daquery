...
public class CreateCDM51Model
{
	...
	{
		InputStream is = CreateCDM51Model.class.getResourceAsStream("/data-modelCDM-5.1.json");
...
/*		finally
	...
	private static DataModel createModel(String cdmConnUrl, String cdmSchemaName, String cdmPassword, String modelName) throws DaqueryException
	{
		...
		try
		{
			...
			dm.setName("CDM-5.1");
			dm.setDescription("PCORI Common Data Model Version 5.1");
			DataExportConfig dec = dm.getCDM51ExportConfigFromFile();
