...
create table site (id varchar(256) NOT NULL PRIMARY KEY, name varchar(256), access_key varchar(256), tempkey boolean, site_url varchar(256), admin_email varchar(256), email_access boolean);
