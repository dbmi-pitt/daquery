create table property (id int NOT NULL PRIMARY KEY, name varchar(256), value varchar(256));
...
create table network (id varchar(256) NOT NULL PRIMARY KEY, name varchar(256));
