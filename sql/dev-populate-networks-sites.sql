...
insert into network(name, id) values('devALL','fb3e4325-dbc5-4501-9fb9-4bd8dbc0a823');
insert into network(name, id) values('devDandC','1169eae7-79ed-41e6-bb62-c86167aef92f');
insert into network(name, id) values('devCandB','9dc38074-a153-4183-a36f-2b64cf75c13c');
insert into network(name, id) values('devDandB','afff8323-176c-4cb0-9d2c-cccc03fff101');
