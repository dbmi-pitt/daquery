...
./start-test-connected.sh --port=4002 --daquery_home=/home/jenkins/projects/daquery/ --db_home=$DB_HOME --ojdbc_lib_dir=/home/jenkins/daquery_lib/ --central_url="$CENTRAL_IP_ADDRESS:4001"
# remove existing site database
sudo rm -rf /home/devuser/daquery_docker_data/daquery-4003
./start-test-noconnection.sh --port=4003 --daquery_home=/home/jenkins/projects/daquery/ --db_home=$DB_HOME --ojdbc_lib_dir=/home/jenkins/daquery_lib/ --central_url="$CENTRAL_IP_ADDRESS:4001"
