...
# THIS SITE WILL RUN ON PORT 4002.  THIS CONFIGURATION INFORMATION MATCHES THE DEFAULT
...
# The default port is set to 4002, but can be changed by providing a port on the 
...
# to use
DAQUERY_CENT_URL="http://10.0.2.15:4001"
